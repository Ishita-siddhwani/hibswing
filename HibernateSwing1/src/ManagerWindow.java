...
public class ManagerWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hh4 = new javax.swing.JPanel();
        jLabel70 = new javax.swing.JLabel();
        jButton18 = new javax.swing.JButton();
        jLabel73 = new javax.swing.JLabel();
        jTextField8 = new javax.swing.JTextField();
        jTextField10 = new javax.swing.JTextField();
        hh5 = new javax.swing.JPanel();
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 640, -1));
        ...
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 25, 80, 40));
        ...
        hh4.setBackground(new java.awt.Color(190, 137, 203));
        ...
        jButton18.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton18jButton11jButton7ActionPerformed(evt);
            }
        });

        jLabel73.setText("beverage name");
        ...
        javax.swing.GroupLayout hh4Layout = new javax.swing.GroupLayout(hh4);
        hh4.setLayout(hh4Layout);
        hh4Layout.setHorizontalGroup(
            hh4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(hh4Layout.createSequentialGroup()
                .addGroup(hh4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(hh4Layout.createSequentialGroup()
                        .addGap(303, 303, 303)
                        .addComponent(jButton18))
                    .addGroup(hh4Layout.createSequentialGroup()
                        .addGap(52, 52, 52)
                        .addGroup(hh4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(hh4Layout.createSequentialGroup()
                            ...
                            .addGroup(hh4Layout.createSequentialGroup()
                                .addComponent(jLabel73, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTextField8, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(0, 72, Short.MAX_VALUE))
        );
        hh4Layout.setVerticalGroup(
            hh4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(hh4Layout.createSequentialGroup()
                .addGap(149, 149, 149)
                .addGroup(hh4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        hh5.setBackground(new java.awt.Color(190, 137, 203));
        ...
        jButton19.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton19jButton11jButton7ActionPerformed(evt);
            }
        });
        ...
        javax.swing.GroupLayout hh5Layout = new javax.swing.GroupLayout(hh5);
        hh5.setLayout(hh5Layout);
        hh5Layout.setHorizontalGroup(
            hh5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(hh5Layout.createSequentialGroup()
                .addGroup(hh5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(hh5Layout.createSequentialGroup()
                        .addGap(303, 303, 303)
                        .addComponent(jButton19))
                    .addGroup(hh5Layout.createSequentialGroup()
                        .addGap(52, 52, 52)
                        .addGroup(hh5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(hh5Layout.createSequentialGroup()
        ...
        hh5Layout.setVerticalGroup(
            hh5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(hh5Layout.createSequentialGroup()
                .addGap(149, 149, 149)
                .addGroup(hh5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel8Layout.createSequentialGroup()
                    .addGap(37, 37, 37)
                    .addComponent(hh5, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-100, 110, 1150, 690));
...
//
//        String foodName;
//        foodName = jList1.getText();
//
//        ManagerMenu menu=new ManagerMenu(foodName);
//        session.save(menu);
//        tx.commit();
//        session.close();
//        JOptionPane.showMessageDialog(this, "INSERTED");
    ...
    private void jButton18jButton11jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18jButton11jButton7ActionPerformed
        // TODO add your handling code here:
         SessionFactory sf=new Configuration().configure().buildSessionFactory();
        Session session=sf.openSession();
        Transaction tx=session.beginTransaction();
        String beverageName=jTextField8.getText();
        String beveragePrice=jTextField10.getText();
 BeverageView bv=new BeverageView(beverageName,beveragePrice);
        session.save(bv);
        tx.commit();
        session.close();
        JOptionPane.showMessageDialog(this, "INSERTED");
    }//GEN-LAST:event_jButton18jButton11jButton7ActionPerformed
    ...
    private void jButton19jButton11jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19jButton11jButton7ActionPerformed
        // TODO add your handling code here:
         SessionFactory sf=new Configuration().configure().buildSessionFactory();
        Session session=sf.openSession();
        Transaction tx=session.beginTransaction();
        String mealName=jTextField9.getText();
        String mealPrice=jTextField11.getText();
 MealView mv=new MealView(mealName,mealPrice);
        session.save(mv);
        tx.commit();
        session.close();
        JOptionPane.showMessageDialog(this, "INSERTED");
    }//GEN-LAST:event_jButton19jButton11jButton7ActionPerformed
    ...
    private javax.swing.JPanel hh4;
    private javax.swing.JPanel hh5;
